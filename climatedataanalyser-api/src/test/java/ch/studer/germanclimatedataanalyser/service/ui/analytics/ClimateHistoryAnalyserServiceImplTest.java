...
class ClimateHistoryAnalyserServiceImplTest {
    ...
    private static final int BEGIN_PERIOD = 1898;
    private static final int END_PERIOD = 2017;
    ...
    void happyFirstInEveryPeriod() {
        ...
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getStartPeriod(), "1988");
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getEndPeriod(), ORIGIN_YEAR);
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getJanuar(), new BigDecimal("1.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getFebruar(), new BigDecimal("2.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getMaerz(), new BigDecimal("3.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getApril(), new BigDecimal("4.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getMai(), new BigDecimal("5.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getJuni(), new BigDecimal("6.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getJuli(), new BigDecimal("7.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getAugust(), new BigDecimal("8.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getSeptember(), new BigDecimal("9.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getOktober(), new BigDecimal("10.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getNovember(), new BigDecimal("11.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getDezember(), new BigDecimal("12.000"));
        //Second Period
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getStartPeriod(), "1958");
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getEndPeriod(), "1987");
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getJanuar(), new BigDecimal("1.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getFebruar(), new BigDecimal("2.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getMaerz(), new BigDecimal("3.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getApril(), new BigDecimal("4.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getMai(), new BigDecimal("5.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getJuni(), new BigDecimal("6.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getJuli(), new BigDecimal("7.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getAugust(), new BigDecimal("8.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getSeptember(), new BigDecimal("9.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getOktober(), new BigDecimal("10.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getNovember(), new BigDecimal("11.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getDezember(), new BigDecimal("12.000"));
        // Third Period
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getStartPeriod(), "1928");
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getEndPeriod(), "1957");
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getJanuar(), new BigDecimal("1.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getFebruar(), new BigDecimal("2.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getMaerz(), new BigDecimal("3.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getApril(), new BigDecimal("4.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getMai(), new BigDecimal("5.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getJuni(), new BigDecimal("6.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getJuli(), new BigDecimal("7.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getAugust(), new BigDecimal("8.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getSeptember(), new BigDecimal("9.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getOktober(), new BigDecimal("10.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getNovember(), new BigDecimal("11.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getDezember(), new BigDecimal("12.000"));
        //Forth Period
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getStartPeriod(), "1898");
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getEndPeriod(), "1927");
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getJanuar(), new BigDecimal("1.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getFebruar(), new BigDecimal("2.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getMaerz(), new BigDecimal("3.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getApril(), new BigDecimal("4.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getMai(), new BigDecimal("5.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getJuni(), new BigDecimal("6.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getJuli(), new BigDecimal("7.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getAugust(), new BigDecimal("8.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getSeptember(), new BigDecimal("9.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getOktober(), new BigDecimal("10.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getNovember(), new BigDecimal("11.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getDezember(), new BigDecimal("12.000"));
    ...
    void happyLastInEveryPeriod() {
        ...
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getStartPeriod(), "1988");
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getEndPeriod(), ORIGIN_YEAR);
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getJanuar(), new BigDecimal("6.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getFebruar(), new BigDecimal("7.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getMaerz(), new BigDecimal("8.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getApril(), new BigDecimal("9.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getMai(), new BigDecimal("10.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getJuni(), new BigDecimal("11.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getJuli(), new BigDecimal("12.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getAugust(), new BigDecimal("13.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getSeptember(), new BigDecimal("14.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getOktober(), new BigDecimal("15.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getNovember(), new BigDecimal("16.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(0).getClimates().getDezember(), new BigDecimal("17.000"));
        //Second Period
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getStartPeriod(), "1958");
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getEndPeriod(), "1987");
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getJanuar(), new BigDecimal("6.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getFebruar(), new BigDecimal("7.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getMaerz(), new BigDecimal("8.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getApril(), new BigDecimal("9.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getMai(), new BigDecimal("10.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getJuni(), new BigDecimal("11.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getJuli(), new BigDecimal("12.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getAugust(), new BigDecimal("13.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getSeptember(), new BigDecimal("14.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getOktober(), new BigDecimal("15.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getNovember(), new BigDecimal("16.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(1).getClimates().getDezember(), new BigDecimal("17.000"));
        // Third Period
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getStartPeriod(), "1928");
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getEndPeriod(), "1957");
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getJanuar(), new BigDecimal("6.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getFebruar(), new BigDecimal("7.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getMaerz(), new BigDecimal("8.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getApril(), new BigDecimal("9.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getMai(), new BigDecimal("10.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getJuni(), new BigDecimal("11.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getJuli(), new BigDecimal("12.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getAugust(), new BigDecimal("13.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getSeptember(), new BigDecimal("14.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getOktober(), new BigDecimal("15.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getNovember(), new BigDecimal("16.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(2).getClimates().getDezember(), new BigDecimal("17.000"));
        //Forth Period
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getStartPeriod(), "1898");
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getEndPeriod(), "1927");
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getJanuar(), new BigDecimal("6.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getFebruar(), new BigDecimal("7.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getMaerz(), new BigDecimal("8.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getApril(), new BigDecimal("9.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getMai(), new BigDecimal("10.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getJuni(), new BigDecimal("11.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getJuli(), new BigDecimal("12.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getAugust(), new BigDecimal("13.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getSeptember(), new BigDecimal("14.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getOktober(), new BigDecimal("15.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getNovember(), new BigDecimal("16.000"));
        Assertions.assertEquals(climateHistoryAverageDtos.get(3).getClimates().getDezember(), new BigDecimal("17.000"));
